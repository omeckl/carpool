...
export default function Navbar({ currentPage, isLoggedIn, navigate, logout }: NavbarProps) {
  return (
            ...
            <>
              ...
              <div className="relative group">
                <div className="flex items-center gap-1 border border-[#DDDDDD] rounded-full px-3 py-2 hover:shadow-md transition-shadow cursor-pointer">
                  ...
                  <div className="w-7 h-7 bg-[#222222] rounded-full flex items-center justify-center ml-1">
                    <svg width="14" height="14" viewBox="0 0 24 24" fill="white">
                      <path d="M12 12c2.7 0 4.8-2.1 4.8-4.8S14.7 2.4 12 2.4 7.2 4.5 7.2 7.2 9.3 12 12 12zm0 2.4c-3.2 0-9.6 1.6-9.6 4.8v2.4h19.2v-2.4c0-3.2-6.4-4.8-9.6-4.8z"/>
                    </svg>
                  </div>
                </div>
                <div className="hidden group-hover:block absolute right-0 top-12 bg-white border border-[#DDDDDD] rounded-2xl shadow-xl w-52 py-2 z-50">
